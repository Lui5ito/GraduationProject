...
def save_sinkhorn_potentials(problem, problem_txt, test, 
    ...
    file_name = "sinkhorn_potentials_" + problem_txt + "_" + subsampling_method_txt + "_" + subsampling_size_txt + "_" + epsilon_txt + "_" + ref_measure_txt + ".npy"
    ...
    metadata = {"problem": problem_txt,
                ...
                "memroy_used": memory_used
                }
    metadat_file_name = "metadata" + problem_txt + "_" + subsampling_method_txt + "_" + subsampling_size_txt + "_" + epsilon_txt + "_" + ref_measure_txt + str(ref_measure_size) + ".json"
...
optimized_indices2000 = np.load("/content/drive/MyDrive/Developer/GraduationProject/Experimental Part/indices_train.npy")
   ...
   for subsampling_method, precomputed_indices, subsampling_method_txt in zip(all_subsampling_method, all_precomputed_indices, all_subsampling_method_txt):
      for subsampling_size, subsampling_size_txt in zip(all_subsampling_size, all_subsampling_size_txt):
         for epsilon, epsilon_txt in zip(all_epsilons, all_epsilon_txt):
            for ref_measure_txt, ref_measure_size in zip(all_ref_measure_txt, all_ref_measure_size):
                save_sinkhorn_potentials(problem = train_split, problem_txt = train_split_txt, test = None,
                                         ...
                                         subsampling_method = subsampling_method, subsampling_method_txt = subsampling_size_txt,
