...
if __name__ == "__main__":
    ...
    raw_data = importing.r37_blades(ids = train, path = None)
    ...
    train_potentials = sinkhorn.proceed(data = train_data, epsilon = epsilon, ref_measure = mu_cloud, numerateur = numerateur, denominateur = denominateur)
    ...
    file_name = "sinkhorn_potentials_" + problem_split + "_" + subsampling_method + "_" + str(subsampling_size) + "_epsilon_" + str(epsilon) + "_" + ref_measure + "_" + str(ref_measure_size) + "_cut_" + str(numerateur) + "_" + str(denominateur) + ".npy"
    np.save(os.path.join(folder_path, file_name), train_potentials)


    # Test data
    start_time_test = time.time()
    test_raw_data = importing.r37_blades(ids = test, path = None)
    # Subsample the blades
    if subsampling_method == "Optimized":
        precomputed_test = np.load("indices_test.npy").astype(int)
    ...
    # Save the data
    file_name = "sinkhorn_potentials_test_" + problem_split + "_" + subsampling_method + "_" + str(subsampling_size) + "_epsilon_" + str(epsilon) + "_" + ref_measure + "_" + str(ref_measure_size) + "_cut_" + str(numerateur) + "_" + str(denominateur) + ".npy"
    ...
    metadat_file_name = "sinkhorn_metadata_" + problem_split + "_" + subsampling_method + "_" + str(subsampling_size) + "_epsilon_" + str(epsilon) + "_" + ref_measure + "_" + str(ref_measure_size) + "_cut_" + str(numerateur) + "_" + str(denominateur) + ".json"
